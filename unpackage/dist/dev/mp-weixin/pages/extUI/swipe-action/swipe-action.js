  ...
  return {
    ...
    x: common_vendor.f($data.swipeList, (item, index, i0) => {
      return {
        ...
        e: "75bd80b9-14-" + i0 + ",75bd80b9-13",
        f: common_vendor.p({
          ["right-options"]: item.options
        })
      };
    }),
    y: common_vendor.sr("swipeAction", "75bd80b9-13")
  };
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/huamo/project/DisplayProject/question-answering/pages/extUI/swipe-action/swipe-action.vue"]]);
