  ...
  return {
    ...
    e: common_vendor.f($data.tableData, (item, index, i0) => {
      return {
        ...
        b: "f99a5192-7-" + i0 + "," + ("f99a5192-6-" + i0),
        c: common_vendor.t(item.name),
        d: "f99a5192-8-" + i0 + "," + ("f99a5192-6-" + i0),
        e: common_vendor.t(item.address),
        f: "f99a5192-9-" + i0 + "," + ("f99a5192-6-" + i0),
        g: "f99a5192-10-" + i0 + "," + ("f99a5192-6-" + i0),
        h: index,
        i: "f99a5192-6-" + i0 + ",f99a5192-0"
      };
    }),
    f: common_vendor.p({
      align: "center"
    }),
    g: common_vendor.sr("table", "f99a5192-0"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/huamo/project/DisplayProject/question-answering/pages/extUI/table/table.vue"]]);
