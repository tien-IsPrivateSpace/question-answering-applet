...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: common_vendor.f(4, (item, index, i0) => {
      return {
        a: "0ab98d36-4-" + i0 + "," + ("0ab98d36-3-" + i0),
        b: index,
        c: "0ab98d36-3-" + i0 + ",0ab98d36-2",
        d: common_vendor.p({
          index
        })
      };
    ...
    g: common_vendor.f(8, (item, index, i0) => {
      return {
        a: "0ab98d36-8-" + i0 + "," + ("0ab98d36-7-" + i0),
        b: index,
        c: "0ab98d36-7-" + i0 + ",0ab98d36-6",
        d: common_vendor.p({
          index
        })
      };
    ...
    D: common_vendor.f($data.list, (item, index, i0) => {
      return common_vendor.e({
        ...
        d: "0ab98d36-22-" + i0 + "," + ("0ab98d36-21-" + i0),
        e: common_vendor.p({
          text: item.badge,
          type: item.type
        })
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/huamo/project/DisplayProject/question-answering/pages/extUI/grid/grid.nvue"]]);
