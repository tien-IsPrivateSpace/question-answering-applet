...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    g: common_vendor.f($data.listData, (item, k0, i0) => {
      return {
        a: "99c05cda-10-" + i0 + "," + ("99c05cda-9-" + i0),
        b: item.id,
        c: "99c05cda-9-" + i0 + ",99c05cda-8",
        d: common_vendor.p({
          title: item.author_name,
          avatar: item.cover,
          note: item.title,
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/huamo/project/DisplayProject/question-answering/pages/extUI/list/chat.vue"]]);
